...
import { ITransaction, TDomain, TokenTransaction, TxValidationParams } from "../types/types";
import { sanitizeDomain } from "../utils/sanitize";
import axios from "axios";
import { isValidTokenTransaction } from "../utils/utilityFN";
...
export const subscribePackageController = async (req: any, res: any) => {
  try {
    ...
    // check if the transaction hash already exist in the database or not. 
